...
chatNameSpace.on("connection", (socket) => {
  ...
  socket.on("send-message", (message, time) => {
    socket.to(socket.userData.roomCode).broadcast.emit(
      "recieved-message",
...
//     socket.userData.animation = player.animation;
//     socket.userData.avatarSkin = player.avatarSkin;
//     socket.userData.room = player.room;
//   });

//   setInterval(() => {
//     const playerData = [];
//     for (const socket of connectedSockets.values()) {
//       if (socket.userData.name !== "" && socket.userData.avatarSkin !== "" && socket.userDat.room !== "") {
//         playerData.push({
//           id: socket.id,
//           name: socket.userData.name,
//           position_x: socket.userData.position.x,
...
//     if (socket.userData.name === "" || socket.userData.avatarSkin === "" || socket.userData.room === "") {
//       return;
//     } else {
